...
@Repository
public interface AnimalRepository extends JpaRepository<Animal, Integer> { //integer vine de la id u din animal

    //stie automat sa faca interogarea de ... dupa nume
    Optional<Animal> findByName(String name);

    //dar putem face interogarea de mana prin @Quary
}
